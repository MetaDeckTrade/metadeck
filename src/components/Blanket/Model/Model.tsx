...
//     useEffect(() => {
//         if(width < 1441 && width > 1300) {
//             setProgress(progressLg)
//         } else if(width <= 1300) {
...
//         config: {duration: 1},
//         onChange: (state) => {
//             console.log(progressRef.current, 'first')
//         }
//     });
...
//         config: {duration: 1},
//         onChange: (state) => {
//             console.log(progressRef.current, 'second')
//         }
//     });
...
//         config: {duration: 1},
//         onChange: (state) => {
//             console.log(progressRef.current, 'third')
//         }
//     });
...
//         to: {
//             x: "-.4", y: "2.9", z: "-.2",
//             positionX: "1", positionY: "-1.6", positionZ: "-1",
//         },
//         config: {duration: 1},
//         onChange: (state) => {
//             console.log(progressRef.current, 'fourth')
//         }
//     });
